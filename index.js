...
module.exports = alpha = async (alpha, bot) => {
    ...
    try {
        ...
        const username = alpha.message.from.username ? alpha.message.from.username : "RexxHayanasi";
                ...
                alpha.reply("Source code this bot", {
                    reply_markup: {
                        inline_keyboard: [
                            [{
                                text: 'Github',
                                url: "https://github.com/Rexxyhoutedt"
                            }, {
                                text: 'YouTube',
                                url: "https://www.youtube.com/@Rexx_ETC"
                            }]
                        ]
                    }
                })
